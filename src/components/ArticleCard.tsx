...
export const ArticleCard: React.FC<ArticleCardProps> = ({ id, title, image, description }) => {
  return (
    <div className="bg-white rounded-2xl shadow-lg text-left overflow-hidden">
      ...
      <div className="p-6">
        ...
        <Link 
          to={`/blog/${id}`}
          className="bg-[#a66642] text-white font-bold py-2 px-4 rounded-lg hover:bg-[#8e5634] transition-colors inline-block"
        >
          Saiba mais
        </Link>
      </div>
